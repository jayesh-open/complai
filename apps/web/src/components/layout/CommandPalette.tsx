...
import {
  ...
  Receipt, Settings, History, Search,
...
const COMMANDS: CommandItem[] = [
  ...
  { id: "nav-einvoice", label: "E-Invoicing", icon: FileCheck2, href: "/compliance/e-invoicing", category: "Navigate" },
  { id: "nav-ewb", label: "E-Way Bill", icon: Truck, href: "/compliance/e-way-bill", category: "Navigate" },
  { id: "nav-itc-recon", label: "ITC Reconciliation", icon: GitCompareArrows, href: "/compliance/itc-reconciliation", category: "Navigate" },
  { id: "nav-vendor-compliance", label: "Vendor Compliance", icon: Gauge, href: "/compliance/vendor-compliance", category: "Navigate" },
  { id: "nav-connected-apps", label: "Connected Apps", icon: Link2, href: "/configure/connected-apps", category: "Navigate" },
