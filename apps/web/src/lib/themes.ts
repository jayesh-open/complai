...
const lightTheme: ThemeColors = {
  ...
  success: "#047857", successMuted: "rgba(4,120,87,0.06)", successBorder: "rgba(4,120,87,0.20)",
  danger: "#b91c1c", dangerMuted: "rgba(185,28,28,0.06)", dangerBorder: "rgba(185,28,28,0.18)",
  warning: "#92400e", warningMuted: "rgba(146,64,14,0.06)", warningBorder: "rgba(146,64,14,0.18)",
  info: "#1d4ed8", infoMuted: "rgba(29,78,216,0.06)", infoBorder: "rgba(29,78,216,0.18)",
  purple: "#6d28d9", purpleMuted: "rgba(109,40,217,0.06)",
  pink: "#be185d", pinkMuted: "rgba(190,24,93,0.06)",
  teal: "#0f766e", tealMuted: "rgba(15,118,110,0.06)",
  orange: "#c2410c", orangeMuted: "rgba(194,65,12,0.06)",
