# ---------------------------------------------------------------
# Complai — Sandbox Environment
# ---------------------------------------------------------------
# Sandbox for API provider integration testing (Adaequare,
# Sandbox.co.in). Similar to dev but with separate VPC CIDR
# and dedicated provider credentials.
# ---------------------------------------------------------------
...
module "cloudflare_dns" {
  ...
  zone_id      = var.cloudflare_zone_id
  domain       = "sandbox.${var.domain_name}"
